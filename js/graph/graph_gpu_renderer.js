    ...
    async createWebGpuPipelines() {
      ...
      const computeModule =
        device.createShaderModule({
          label: window.RMLI18n.t("ui.literal.c0f8fc186b10"),
          code: `
            struct CullUniforms {
              bounds: vec4<f32>,
              wireCount: u32,
      ...
      const gridModule =
        device.createShaderModule({
          label: window.RMLI18n.t("ui.literal.910c8808c36a"),
          code: `
      ...
      const wireModule =
        device.createShaderModule({
          label: window.RMLI18n.t("ui.literal.f4798ad1ce95"),
          code: `
            struct RenderUniforms {
              resolution: vec2<f32>,
              pan: vec2<f32>,
      ...
      const nodeModule =
        device.createShaderModule({
          label: window.RMLI18n.t("ui.literal.874ca39eb4de"),
          code: `
            struct RenderUniforms {
              resolution: vec2<f32>,
              pan: vec2<f32>,
      ...
      const computeDescriptor = {
          label: window.RMLI18n.t("ui.literal.d8f4b30e57a8"),
          layout: "auto",
          compute: {
      ...
      const gridDescriptor = {
          label: window.RMLI18n.t("ui.literal.0880ddfab2e9"),
          layout: "auto",
          vertex: {
            module: gridModule,
      ...
      const wireDescriptor = {
          label: window.RMLI18n.t("ui.literal.4113397084e1"),
          layout: "auto",
          vertex: {
            module: wireModule,
            entryPoint: "vertexMain"
      ...
      const nodeDescriptor = {
          label: window.RMLI18n.t("ui.literal.5a266d519e16"),
          layout: "auto",
          vertex: {
            module: nodeModule,
            entryPoint: "vertexMain"
    ...
    draw() {
      ...
      const encoder =
        device.createCommandEncoder({
          label: window.RMLI18n.t("ui.literal.ddfc6bd256a2")
        });
      if (needsCull) {
        encoder.clearBuffer(
          this.gpuBuffers.wireIndirect,
        ...
        if (maximumCount > 0) {
          const compute =
            encoder.beginComputePass({
              label: window.RMLI18n.t("ui.literal.ae82a2262f5a")
            });
          compute.setPipeline(
            this.gpuPipelines.compute
          );
      ...
      const render = encoder.beginRenderPass({
        label: window.RMLI18n.t("ui.literal.cb0c4b66c63b"),
        colorAttachments: [{
          view:
            this.gpuContext
              .getCurrentTexture()

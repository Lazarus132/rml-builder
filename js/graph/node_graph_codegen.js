...
function sanitizeGraphState(
    ...
    const migrateRuntimeFamilyOperator = (nodeId, operatorId, parameters) => {
      ...
      if (operatorId === "harmony.exactPatchSource") {
        parameters.mode = "file";
        parameters.filePreset = "harmonyExact";
        parameters.source = String(parameters.content || parameters.source || "");
        parameters.fileName = parameters.fileName || "ExactHarmonyPatches.cs";
        parameters.projectId = "main";
        parameters.nullable = parameters.nullable || "inherit";
        parameters.autoGeneratedHeader = false;
        delete parameters.content;
        return "csharp.file";
      }
      if (operatorId === "harmony.earlyPatchSource") {
        parameters.mode = "file";
        parameters.filePreset = "harmonyEarly";
        parameters.source = String(parameters.content || parameters.source || "");
        parameters.fileName = parameters.fileName || "EarlyHarmonyPatches.cs";
        parameters.projectId = "main";
        parameters.harmonyPatchOrder = Number.isFinite(Number(parameters.loadOrder))
          ? Math.trunc(Number(parameters.loadOrder))
          : 0;
        parameters.nullable = parameters.nullable || "inherit";
        parameters.autoGeneratedHeader = false;
        delete parameters.content;
        delete parameters.loadOrder;
        return "csharp.file";
      }
...
function configurationDefinition() {
    ...
    return {
      ...
      symbol: "§",
      description:
        window.RMLI18n.t("ui.auto.b6803f28c9ad"),
      inputs: [],
      outputs,
      width: 280
    };
...
function graphAnalysisAbortError(
    message = window.RMLI18n.t("ui.auto.021d88ed9952")
  ) {

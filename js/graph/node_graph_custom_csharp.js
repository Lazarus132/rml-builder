...
function buildCustomCSharpFragmentInWorker(nodeId, source, parseResult, options) {
    ...
    const worker = new Worker(
      new URL(
        "js/workers/graph_codegen_worker.js?v=1.21.20-universal-presentation-dev419-runtime-color-fidelity-overlay-open",
        document.baseURI
      ),
...
function createCustomCSharpOverlayFrame(
    ...
    const windowIcon = name =>
      `<svg viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.20-universal-presentation-dev419-runtime-color-fidelity-overlay-open#icon-${name}"></use></svg>`;

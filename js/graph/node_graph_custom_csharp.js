...
function buildCustomCSharpFragmentInWorker(nodeId, source, parseResult, options) {
    ...
    const worker = new Worker(
      new URL(
        "js/workers/graph_codegen_worker.js?v=1.21.12-universal-presentation-dev409-preview-enum-icon-bounds",
        document.baseURI
      ),
...
function createCustomCSharpOverlayFrame(
    ...
    const windowIcon = name =>
      `<svg viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.12-universal-presentation-dev409-preview-enum-icon-bounds#icon-${name}"></use></svg>`;

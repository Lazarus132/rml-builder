...
function buildCustomCSharpFragmentInWorker(nodeId, source, parseResult, options) {
    ...
    const worker = new Worker(
      new URL(
        "js/workers/graph_codegen_worker.js?v=1.21.01-universal-presentation-dev398-source-comment-cleanup",
        document.baseURI
      ),
...
function createCustomCSharpOverlayFrame(
    ...
    const windowIcon = name =>
      `<svg viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.01-universal-presentation-dev398-source-comment-cleanup#icon-${name}"></use></svg>`;
...
function prepareCustomCSharpEditorHost(
    ...
    stylesheet.href = new URL(
      "styles/features/styles.runtime-graph.css?v=1.21.01-universal-presentation-dev398-source-comment-cleanup",

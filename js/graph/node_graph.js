(() => {
  ...
  const workerFiles = [
    ...
    "node_graph_codegen.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity"
  ];
  ...
  const files = [
    ...
    ...(
      window.RMLClassStyles
        ? []
        : [
            "../loaders/style_loader.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity"
          ]
    ),
    "node_graph_registry.js?v=1-physical-modules-v750-offline-core-types",
    "node_graph_codegen.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity",
    "runtime_bridge.js?v=1000-live-loss-status",
    "../workers/saved_api_composite_compare_worker.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity",
    "node_graph_composites.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity",
    "node_graph_custom_csharp.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity",
    "node_graph_guided.js?v=1-physical-modules-v748",
    "node_graph_view.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity",
    "graph_gpu_renderer.js?v=807-webgpu-texture-limits",
    "node_graph_bootstrap.js?v=1.20.31-universal-presentation-dev108-live-content-layout-parity"
  ];

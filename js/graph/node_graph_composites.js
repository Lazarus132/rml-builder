...
const savedApiCompositeSearchTextCache =
  ...
  async function ensureSavedApiCompositeCompareWorker() {
    ...
    const workerUrl = new URL(
      "js/workers/saved_api_composite_compare_worker.js?v=1.21.18-universal-presentation-dev417-preview-color-page-isolation&canonical-schema=4",
      document.baseURI
    );
    const workerOptions = {
  ...
  function refreshVisibleSavedApiCompositePaletteRows(
    ...
    for (const row of visibleRows) {
      ...
      if (!compatibilityIssue && !currentOpen && available) {
        marker.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.18-universal-presentation-dev417-preview-color-page-isolation#icon-add"></use></svg>`;
      } else {
...
function synchronizeSavedApiCompositeUpdateAction(
    ...
    if (!updateGraphButton) {
      ...
      updateGraphButton.innerHTML = `<svg viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.18-universal-presentation-dev417-preview-color-page-isolation#icon-update"></use></svg>`;
...
function createSavedApiCompositePaletteItem(
    ...
    if (!compatibilityIssue && !currentOpen && savedCompositeAvailable) {
      add.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.18-universal-presentation-dev417-preview-color-page-isolation#icon-add"></use></svg>`;
    } else {
    ...
    exportButton.innerHTML = `<svg viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.18-universal-presentation-dev417-preview-color-page-isolation#icon-download"></use></svg>`;
    exportButton.title =
    ...
    deleteButton.innerHTML = `<svg viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.18-universal-presentation-dev417-preview-color-page-isolation#icon-close"></use></svg>`;
    deleteButton.title =
    ...
    menuTrigger.innerHTML = `<svg viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.18-universal-presentation-dev417-preview-color-page-isolation#icon-more"></use></svg>`;

  ...
  function appendDynamicPreview() {
    ...
    for (const node of controls) {
      ...
      if (
        ...
        previousButton.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.01-universal-presentation-dev398-source-comment-cleanup#icon-triangle-left"></use></svg>`;
        ...
        nextButton.className =
          "rml-preview-control rml-preview-enum-step";
        nextButton.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.01-universal-presentation-dev398-source-comment-cleanup#icon-triangle-right"></use></svg>`;
...
(() => {
  ...
  function installEditablePalette() {
    ...
    for (const entry of desired) {
      ...
      plus.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.01-universal-presentation-dev398-source-comment-cleanup#icon-add"></use></svg>`;

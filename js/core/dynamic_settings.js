  ...
  function appendDynamicPreview() {
    ...
    for (const node of controls) {
      ...
      if (
        ...
        previousButton.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.03-universal-presentation-dev400-edit-mode-sidebar-access#icon-triangle-left"></use></svg>`;
        ...
        nextButton.className =
          "rml-preview-control rml-preview-enum-step";
        nextButton.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.03-universal-presentation-dev400-edit-mode-sidebar-access#icon-triangle-right"></use></svg>`;
...
(() => {
  ...
  function installEditablePalette() {
    ...
    for (const entry of desired) {
      ...
      plus.innerHTML = `<svg class="rml-inline-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="assets/rml-icons.svg?v=1.21.03-universal-presentation-dev400-edit-mode-sidebar-access#icon-add"></use></svg>`;

(() => {
  ...
  async function mount(options = {}) {
    ...
    const iconSpriteUrl = new URL("assets/rml-icons.svg?v=1.20.32-universal-presentation-dev182-mobile-settings-color-picker-state-switch", window.location.href).href;

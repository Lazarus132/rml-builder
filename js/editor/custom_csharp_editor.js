(() => {
  ...
  function ensureCustomCSharpShortcutBootstrap(popup) {
    const property =
      window.RMLI18n.t("ui.literal.a05ce0c95bc5");
  ...
  const normalizedDiagnostics = values => {
    ...
    if (Array.isArray(values)) {
      ...
      append(window.RMLI18n.t("index.text.ec0abfff4432"), values.Builder || values.builder);
      append(window.RMLI18n.t("index.text.b5e50a2e9087"), values.Roslyn || values.roslyn);
    }
    return groups;
  };
  ...
  async function mount(options = {}) {
    ...
    popupDocument.documentElement.lang =
      options.language || "en";
    popupDocument.title =
      String(options.documentTitle || window.RMLI18n.t("ui.auto.0badde6be4fb"));
    ...
    const iconSpriteUrl = new URL("assets/rml-icons.svg?v=1.21.15-universal-presentation-dev414-export-compiled-copy-state-dedupe", window.location.href).href;
    ...
    const showFind = createHeaderButton(
      window.RMLI18n.t("ui.auto.d97e38854082"),
      "search"
    );
    const showReplace = createHeaderButton(
      window.RMLI18n.t("ui.literal.45ea05cff7c2"),
      "replace"
    );
    ...
    const showSettings = createHeaderButton(
      window.RMLI18n.t("ui.auto.810e323d298c"),
      "settings"
    );
    ...
    const popupReturnToEmbedded = createHeaderButton(
      window.RMLI18n.t("ui.auto.6f52e3afd3c5"),
      "back"
    );
    ...
    for (const [value, label] of [
      ["overlay", window.RMLI18n.t("ui.literal.249450cb7225")],
      ["external", window.RMLI18n.t("ui.literal.83182e9b12ce")]
    ]) {
      const option =
    ...
    const createPresentationDropdown = () => {
      ...
      trigger.addEventListener("keydown", event => {
        if (
          ...
          event.key === window.RMLI18n.t("ui.literal.e710c17948e9") ||
          event.key === window.RMLI18n.t("ui.literal.2b9eceb7a86a") ||
          event.key === " "
        ) {
          event.preventDefault();
          if (!opened) open();
          if (event.key === window.RMLI18n.t("ui.literal.e710c17948e9")) {
      ...
      optionsHost.addEventListener("keydown", event => {
        if (event.key === window.RMLI18n.t("ui.literal.b4cfe1f435f0")) {
          event.preventDefault();
          close(true);
        } else if (event.key === window.RMLI18n.t("ui.literal.14a67093e73a")) {
          event.preventDefault();
          moveFocus(1);
        } else if (event.key === window.RMLI18n.t("ui.literal.e710c17948e9")) {
          event.preventDefault();
          moveFocus(-1);
        } else if (event.key === window.RMLI18n.t("ui.literal.70f8bb9a8a53")) {
          event.preventDefault();
          optionButtons[0]?.focus({ preventScroll: true });
        } else if (event.key === window.RMLI18n.t("ui.literal.a2bb9d34b8a1")) {
          event.preventDefault();
          optionButtons.at(-1)?.focus({ preventScroll: true });
        }
      });
    ...
    textarea.setAttribute("aria-label", String(options.ariaLabel || window.RMLI18n.t("ui.auto.ec4bfc434347")));
    ...
    const matchCase = createFindButton(window.RMLI18n.t("ui.auto.653125ce2a9b"), "Aa");
    const wholeWord = createFindButton(window.RMLI18n.t("ui.auto.1f0fc632c4e9"), "ab");
    const regularExpression = createFindButton(window.RMLI18n.t("ui.auto.cd1ad38a2008"), ".*");
    ...
    const previousMatch = createFindButton(window.RMLI18n.t("ui.auto.ef4b365e7af5"), "", "chevron-up");
    const nextMatch = createFindButton(window.RMLI18n.t("ui.auto.c307fb8c6b3e"), "", "chevron-down");
    const hideFind = createFindButton(window.RMLI18n.t("ui.auto.14565f45b93d"), "", "close");
    ...
    const replaceCurrent = createFindButton(window.RMLI18n.t("ui.auto.2c006022d959"), window.RMLI18n.t("js.presentation.a7cf7b25a703"));
    const replaceAll = createFindButton(window.RMLI18n.t("ui.auto.6100bc245f74"), window.RMLI18n.t("ui.literal.9bc1c6c021ad"));
      ...
      options.diagnosticSource ||
        (() => {
          try {
            ...
            return window.RMLI18n.t("index.text.b5e50a2e9087");
          }
        })()
    );
    ...
    for (const source of [window.RMLI18n.t("index.text.ec0abfff4432"), window.RMLI18n.t("index.text.b5e50a2e9087")]) {
      const button = popupDocument.createElement("button");
      button.type = "button";
    ...
    const appearanceEntries = [
      ["background", window.RMLI18n.t("ui.literal.45d591e5793a")],
      ["gutter", window.RMLI18n.t("ui.literal.8fc5e232d010")],
      ["workbench", window.RMLI18n.t("ui.literal.cc7ae3d130f5")],
      ["panel", window.RMLI18n.t("ui.literal.ed80dd65b4f2")],
      ["overlay", window.RMLI18n.t("ui.literal.c7f22ee034db")],
      ["status", window.RMLI18n.t("ui.literal.0fd8272072d2")],
      ["selection", window.RMLI18n.t("ui.literal.ad228a8a102b")],
      ["text", window.RMLI18n.t("ui.literal.633bcc03c942")],
    ...
    statusMessage.textContent = String(options.status || window.RMLI18n.t("ui.literal.3318b07e4347"));
    ...
    const viewDefinitions = [
      ["output", window.RMLI18n.t("ui.literal.feb3522a4038")],
      ["problems", window.RMLI18n.t("ui.literal.4bd445ed1e3e")],
      ["debug", window.RMLI18n.t("ui.literal.316e3eb22c60")]
    ];
    const views = new Map();
    const tabs = new Map();
    ...
    const embeddedLayerDefinitions = [
      {
        ...
        label:
          ...
          window.RMLI18n.t("ui.literal.76b7d2ab9992")
      },
      {
        ...
        label:
          window.RMLI18n.t("ui.auto.a1233f2f4a1a")
      },
      ...viewDefinitions.map(
        ([id, label]) => ({
      ...
      ),
      {
        ...
        label:
          window.RMLI18n.t("ui.auto.5299dd74190f")
      },
      {
        ...
        label:
          window.RMLI18n.t("ui.auto.2e98d4c2de80")
      },
      ...Array.from(
        ...
        (scrollElement, index) => ({
          ...
          label:
            window.RMLI18n.t("ui.auto.039b8f984664")
        })
      )
    ].filter(
      definition =>
    ...
    const renderEntries = (
      ...
      if (!visibleEntries.length) {
        ...
        empty.textContent =
          viewId === "debug"
            ? window.RMLI18n.t("ui.literal.80a73ea3934c")
            : window.RMLI18n.t("ui.literal.787035ed6c6d");
      ...
      for (const entry of visibleEntries) {
        ...
        source.textContent = String(entry.source || window.RMLI18n.t("index.text.ec0abfff4432"));
    ...
    const storeOutputEntry = entry => {
      const normalized = Object.freeze({
        ...
        source: String(entry?.source || window.RMLI18n.t("index.text.ec0abfff4432")),
        sourceGroup: outputDiagnosticSource(
          entry?.source || window.RMLI18n.t("index.text.ec0abfff4432")
        ),
    ...
    const commit = () => {
      ...
      const label = validationPending ? window.RMLI18n.t("ui.literal.050257c0aa32") : window.RMLI18n.t("ui.literal.3318b07e4347");
    ...
    const insertNodeSnippet = snippetValue => {
      ...
      statusMessage.textContent = String(
        snippetValue?.status ||
        window.RMLI18n.t("ui.literal.d66fac4295b2")
      );
    ...
    const updateMatchStatus = error => {
      ...
      for (const button of [
        ...
        button.title = unavailable
          ? error
            ? window.RMLI18n.t("ui.literal.01a453795aca")
            : window.RMLI18n.t("ui.literal.7b36773a6422")
          : "";
      }
    };
    ...
    const replaceActiveMatch = () => {
      ...
      appendOutput({
        ...
        tone: "success",
        message: window.RMLI18n.t("ui.auto.e76a3086ebc4")
      });
    };
    ...
    const clearEditorScrollForKey = event => {
      if (event.key !== window.RMLI18n.t("ui.literal.ea1d3df298ca") && event.key !== window.RMLI18n.t("ui.literal.8d546a6dea9f") &&
          !(event.key === window.RMLI18n.t("ui.literal.469d5b183fdc") && (localScrollSession?.candidates[localScrollSession.index] || localScrollSelection)?.snapshot.axes.x)) {
        clearLocalScrollSelection();
      }
    ...
    textarea.addEventListener(
      ...
      event => {
        if (
          event.key === window.RMLI18n.t("ui.literal.fe06eb6459c8") &&
          !event.ctrlKey &&
          !event.metaKey &&
          !event.altKey
        ) {
    ...
    const record = Object.freeze({
      ...
      setStatus(status) {
        const state =
          status && typeof status === "object"
            ...
            : { message: status };
        statusMessage.textContent =
          String(state.message || window.RMLI18n.t("ui.literal.3318b07e4347"));
        statusMessage.dataset.tone =
      ...
      setValidationPending(pending) {
        ...
        debugPanel.title = next ? window.RMLI18n.t("ui.literal.e83f942ff431") : "";
        statusMessage.textContent = next ? window.RMLI18n.t("ui.literal.050257c0aa32") : window.RMLI18n.t("ui.literal.3318b07e4347");
        statusMessage.dataset.tone = "info";
      },

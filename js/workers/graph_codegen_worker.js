...
async function ensureRuntime(
  ...
  if (!runtimeReady) {
    ...
    importScripts(
      "../catalog/api_nodes.js?v=1.20.31-universal-presentation-dev72-synchronous-retained-drag"
    );
    ...
    importScripts(
      "../graph/node_graph_codegen.js?v=1.20.31-universal-presentation-dev72-synchronous-retained-drag"
    );

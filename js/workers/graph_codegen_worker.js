...
async function ensureRuntime(
  ...
  if (!runtimeReady) {
    ...
    importScripts(
      "../catalog/api_nodes.js?v=1.20.31-universal-presentation-dev83-open-never-update-invariant"
    );
    ...
    importScripts(
      "../graph/node_graph_codegen.js?v=1.20.31-universal-presentation-dev83-open-never-update-invariant"
    );

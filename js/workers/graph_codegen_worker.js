...
async function ensureRuntime(
  ...
  if (!runtimeReady) {
    ...
    importScripts(
      "../catalog/api_nodes.js?v=1.21.06-universal-presentation-dev403-node-root-scroll"
    );
    ...
    importScripts(
      "../graph/node_graph_codegen.js?v=1.21.06-universal-presentation-dev403-node-root-scroll"
    );
